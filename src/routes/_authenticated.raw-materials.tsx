...
export const Route = createFileRoute("/_authenticated/raw-materials")({
  head: () => ({
    meta: [
      { title: "Matière première — DryNuts" },
      { name: "description", content: "Stock de fruits secs bruts et lots réceptionnés." },
    ],
  }),
...
function RawMaterials() {
  ...
  return (
    <div>
      <PageHeader
        title="Stock matière première"
        subtitle="Fruits secs bruts par lot et fournisseur"
      />
      <CrudTable<RawMaterial>
        ...
        columns={[
          ...
          { key: "quantityKg", label: "Quantité (kg)", render: (r) => r.quantityKg.toLocaleString("fr-FR") },
          {
            key: "supplierId",
            label: "Fournisseur",
